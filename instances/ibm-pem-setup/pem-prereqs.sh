...
"/mnt/c/ibm_sdk80/jre/bin/keytool.exe -genkey -keystore ibm-pem.jks -storepass ${SERVER_KEYSTORE_PASSWORD} -alias pem -dname "CN=*.${DOMAIN}" -keypass ${SERVER_KEYSTORE_PASSWORD} -sigalg SHA256withRSA -keyalg RSA"
